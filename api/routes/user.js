...
const member = require('../../models/userDetails');
            ...
            User.sync({ force: false }).then(() => {
                ...
                if (isExist === true) {
                    ...
                    var mailOptions = {
                        ...
                        text: 'Hello , ' + req.body.FName + ' Thank you for the registering . Please Click on activation link below : http://localhost:4200/service/' + token,
                        html: 'Hello <strong>' + req.body.FName + '</strong> , <br/> <br/> Thank You for Registering at WorkLoad . Please activate your account by clicking the link below : <br/><br/><a href="http://localhost:4200/service/' + token + '">http://localhost:4200/accounts</a>'
                    };
